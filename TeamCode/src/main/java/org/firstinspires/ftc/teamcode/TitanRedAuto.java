...
@Disabled
@Autonomous(name="Titan Red Auto", group="Testing")
public class TitanRedAuto extends OpMode {
    ...
    public void loop() {
        ...
        /*This only reads the red and always knocks it off, idk why, i think the values are too large*/
